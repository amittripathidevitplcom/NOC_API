...
namespace RJ_NOC_Utility.CustomerDomain.Interface
{
    public interface ICommonFuncation
    {
        ...
        List<CommonDataModel_DepartmentMasterList> GetDepartmentList_IsOpenDefaulter();
        ...
        List<CommonDataModel_FinancialYearDDL> GetAllFinancialYear_AcademicInformation(int DepartmentID);
        ...
        List<CommonDataModel_RoleListByLevel> GetRoleListForApporval(int RoleID, int DepartmentID, string NOCType);
        List<CreateUserDataModel> GetUserDetailsByRoleID(int RoleID, int DepartmentID, int ApplyNOCID);

        List<CommonDataModel_WorkFlowActionsByRole> GetWorkFlowActionListByRole(int RoleID, string Type, int DepartmentID, string NOCType, int ApplyNOCID);
        ...
        List<CommonDataModel_DataTable> GetPreviousTotalApplicationListByDepartment(CommonDataModel_TotalApplicationSearchFilter request);
        ...
        List<CommonDataModel_BTEROrderList> UpdateGeneratedBTERPDF(string fileName, string GenOrderNumber);
