...
namespace RJ_NOC_API.Controllers
{
    ...
    public class QualificatioinMasterController : RJ_NOC_ControllerBase
    {
        ...
        [HttpGet]
        public async Task<OperationResult<List<CommonDataModel_DataTable>>> GetQualificationMasterList()
        {
            CommonDataAccessHelper.Insert_TrnUserLog(0, "GetAllData", 0, "QualificatioinMaster");
            var result = new OperationResult<List<CommonDataModel_DataTable>>();
            try
            {
                result.Data = await Task.Run(() => UtilityHelper.QualificationMasterUtility.GetQualificationMasterList());
