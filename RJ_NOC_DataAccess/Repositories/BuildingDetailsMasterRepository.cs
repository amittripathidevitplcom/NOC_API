...
namespace RJ_NOC_DataAccess.Repository
{
    public class BuildingDetailsMasterRepository : IBuildingDetailsMasterRepository
    {
        ...
        public bool SaveData(BuildingDetailsDataModel buildingdetails)
        {
            ...
            SqlQuery += " @ResidentialBuildingTypeID='" + buildingdetails.ResidentialBuildingTypeID + "',";
            SqlQuery += " @MGOneResidentialIstheCampusUnitary='" + buildingdetails.MGOneResidentialIstheCampusUnitary + "',";
            SqlQuery += " @ResidentialOwnerName='" + buildingdetails.ResidentialOwnerName + "',";
            SqlQuery += " @ResidentialAddressLine1='" + buildingdetails.ResidentialAddressLine1 + "',";
            SqlQuery += " @ResidentialAddressLine2='" + buildingdetails.ResidentialAddressLine2 + "',";
            SqlQuery += " @ResidentialRuralUrban='" + buildingdetails.ResidentialRuralUrban + "',";
            SqlQuery += " @ResidentialDistance='" + buildingdetails.ResidentialDistance + "',";
            SqlQuery += " @ResidentialDivisionID='" + buildingdetails.ResidentialDivisionID + "',";
            SqlQuery += " @ResidentialDistrictID='" + buildingdetails.ResidentialDistrictID + "',";
            SqlQuery += " @ResidentialTehsilID='" + buildingdetails.ResidentialTehsilID + "',";
            SqlQuery += " @ResidentialCityID='" + buildingdetails.ResidentialCityID + "',";
            SqlQuery += " @ResidentialPanchayatSamitiID='" + buildingdetails.ResidentialPanchayatSamitiID + "',";
            SqlQuery += " @ResidentialCityTownVillage='" + buildingdetails.ResidentialCityTownVillage + "',";
            SqlQuery += " @ResidentialContactNo='" + buildingdetails.ResidentialContactNo + "',";
            SqlQuery += " @ResidentialPincode='" + buildingdetails.ResidentialPincode + "',";
            SqlQuery += " @ResidentialBuildingHostelQuartersRoadArea='" + buildingdetails.ResidentialBuildingHostelQuartersRoadArea + "',";
            SqlQuery += " @ResidentialRentvaliditydate='" + buildingdetails.ResidentialRentvaliditydate + "',";
            SqlQuery += " @ResidentialbuildingOtherDoc1FileUpload='" + buildingdetails.ResidentialbuildingOtherDoc1FileUpload + "',";
            SqlQuery += " @ResidentialbuildingOtherDoc2FileUpload='" + buildingdetails.ResidentialbuildingOtherDoc2FileUpload + "',";
            SqlQuery += " @ResidentialRentAgreementFileUpload='" + buildingdetails.ResidentialRentAgreementFileUpload + "',";
            SqlQuery += " @AuthoritybuildingOtherDoc1FileUpload='" + buildingdetails.AuthoritybuildingOtherDoc1FileUpload + "',";
            SqlQuery += " @MGOneDrainage='" + buildingdetails.MGOneDrainage + "',";
            SqlQuery += " @BuildingUseNameoftheAuthority='" + buildingdetails.BuildingUseNameoftheAuthority + "',";
            SqlQuery += " @BuildingUseOrderNo='" + buildingdetails.BuildingUseOrderNo + "',";
            SqlQuery += " @buildingUseOtherDoc1FileUpload='" + buildingdetails.buildingUseOtherDoc1FileUpload + "',";
            SqlQuery += " @BuildingUseDateApproval='" + buildingdetails.BuildingUseDateApproval + "',";
            SqlQuery += " @PollutionDateApproval='" + buildingdetails.PollutionDateApproval + "',";
            SqlQuery += " @ValidDateApproval='" + buildingdetails.ValidDateApproval + "',";
            SqlQuery += " @PollutionbuildingOtherDoc1FileUpload='" + buildingdetails.PollutionbuildingOtherDoc1FileUpload + "',";
