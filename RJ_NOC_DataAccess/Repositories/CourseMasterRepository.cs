...
namespace RJ_NOC_DataAccess.Repository
{
    public class CourseMasterRepository : ICourseMasterRepository
    {
        ...
        {
            string SqlQuery = " exec USP_CourseMaster_GetData  @LoginSSOID='" + LoginSSOID + "',@CollegeID='" + CollegeID + "',@ApplyNOCID='" + ApplyNOCID + "'";
        ...
        {
            string SqlQuery = " exec USP_CourseMaster_GetData_DTE @LoginSSOID ='" + LoginSSOID + "',@CollegeWiseCourseID='" + CollegeWiseCourseID + "',@CollegeID='" + CollegeID + "',@ApplyNOCID='" + ApplyNOCID + "'";
            DataTable dataTable = new DataTable();
