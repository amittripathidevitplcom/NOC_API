...
namespace RJ_NOC_DataAccess.Repositories
{
    public class FacilityDetailsRepository : IFacilityDetailsRepository
    {
        ...
        public bool SaveData(FacilityDetailsDataModel request)
        {
            ...
            string SqlQuery = " exec USP_Trn_School_FacilityDetails_IU  ";
            SqlQuery += " @FacilityDetailID='" + request.FacilityDetailID + "',@FacilitiesID='" + request.FacilitiesID + "',@FacilitiesUrl='" + request.FacilitiesUrl + "',@MinSize='" + request.MinSize +"'";
        ...
        {
            string SqlQuery = " exec USP_Trn_School_FacilityDetails_GetData";
        ...
        {
            string SqlQuery = " exec USP_Trn_School_FacilityDetails_GetData @FacilityDetailID='" + FacilityDetailID + "'";
            DataTable dataTable = new DataTable();
        ...
        {
            string SqlQuery = " Update Trn_School_FacilityDetails set ActiveStatus=0 , DeleteStatus=1  WHERE FacilityDetailID='" + FacilityDetailID + "'";
