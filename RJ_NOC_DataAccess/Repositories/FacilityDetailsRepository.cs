...
namespace RJ_NOC_DataAccess.Repositories
{
    public class FacilityDetailsRepository : IFacilityDetailsRepository
    {
        ...
        public bool SaveData(FacilityDetailsDataModel request)
        {
            ...
            SqlQuery += " @CollegeID='" + request.CollegeID + "',@FacilityDetailID='" + request.FacilityDetailID + "',@FacilitiesID='" + request.FacilitiesID + "',@NoOf='" + request.NoOf + "',@FacilitiesUrl='" + request.FacilitiesUrl + "',@MinSize='" + request.MinSize + "',@CreatedBy='" + request.CreatedBy + "',@ModifyBy='" + request.ModifyBy + "',@IPAddress='" + IPAddress + "',@IsAvailable='" + request.IsAvailable + "'";
        ...
        public List<FacilityDetailsDataModels> GetFacilityDetailAllList(int CollegeID, int ApplyNOCID)
        {
            string SqlQuery = " exec USP_Trn_College_FacilityDetails_GetData @CollegeID = '" + CollegeID + "',@ApplyNOCID = '" + ApplyNOCID + "'";
