        ...
        public List<StaffDetailDataModel> GetStaffDetailList_DepartmentCollegeWise(int DepartmentID, int CollegeID, int StaffDetailID, int ApplyNOCID)
        {
            ...
            else
            {
                if (dataSet.Tables[0].Rows.Count > 0)
                {
                    ...
                    dataModels.MgoneDepartmentID = Convert.ToInt32(dataSet.Tables[0].Rows[0]["MgoneDepartmentID"]);
                    dataModels.MGOneDepartmentName = dataSet.Tables[0].Rows[0]["MGOneDepartmentName"].ToString();
