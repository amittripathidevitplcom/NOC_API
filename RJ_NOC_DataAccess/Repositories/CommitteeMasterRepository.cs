...
namespace RJ_NOC_DataAccess.Repository
{
    public class CommitteeMasterRepository : ICommitteeMasterRepository
    {
        ...
        public bool SaveApplicationCommitteeData(PostApplicationCommitteeMemberdataModel request)
        {
            ...
            string IPAddress = CommonHelper.GetVisitorIPAddress();
            string SqlQuery = " exec USP_SaveApplicationCommitteeMember @UserID='" + request.UserID + "', @ApplyNocApplicationID='" + request.ApplyNocApplicationID + "',@CommitteeMasterDetail_Str='" + CommitteeMasterDetail_Str + "',@CommitteeDocument='" + request.CommitteeDocument + "'";
        ...
        public bool SaveApplicationCommitteeData_AH(PostApplicationCommitteeMemberdataModel request)
        {
            string CommitteeMasterDetail_Str = CommonHelper.GetDetailsTableQry(request.ApplicationCommitteeList, "Temp_CommitteeMasterDetail");
            string IPAddress = CommonHelper.GetVisitorIPAddress();
            string SqlQuery = " exec USP_SaveApplicationCommitteeMember_AH @UserID='" + request.UserID + "', @ApplyNocApplicationID='" + request.ApplyNocApplicationID + "',@CommitteeMasterDetail_Str='" + CommitteeMasterDetail_Str + "',@CommitteeDocument='" + request.CommitteeDocument + "'";
