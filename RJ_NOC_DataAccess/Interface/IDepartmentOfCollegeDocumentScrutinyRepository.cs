...
{
    public interface IDepartmentOfCollegeDocumentScrutinyRepository
    {
        ...
        List<CommonDataModel_DataTable> GetGrievanceReport(string FromDate, string ToDate, int DepartmentID, int CollegeID);
        ...
        List<DepartmentOfCollegeDocumentScrutinyDataModel_PaymentDetails> DocumentScrutiny_OnlinePaymentDetail(int CollageID, int RoleID, int ApplyNOCID);
